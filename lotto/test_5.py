...
def prepare_data(wins_file):
    ...
    for i in range(len(draws) - 1):
        ...
        # Convert draw date (round) to numerical feature
        draw_number_feature = draws[i]['draw_number']

        # Convert additional_info (sum) to numerical feature
        draw_sum_feature = int(draws[i]['additional_info'].split()[0])
        ...
        # Append the draw number and draw sum as features
        current_features.append(draw_number_feature)
        current_features.append(draw_sum_feature)
